    ...
    spawnQuest(index) { 
        ...
        switch (index) {
            case 0:
                ...
                questScript.questLabel.string = Language.getDracoText();
            ...
            case 1:
                ...
                questScript.questLabel.string = Language.getAlbusText();
                break;
            case 2:
                questScript.dataMatch = 2;
                questScript.questLabel.string = Language.getMinervaText();
                break;
            case 3:
                questScript.dataMatch = 3;
                questScript.questLabel.string = Language.getHarryText();
                break;
            case 4:
                questScript.dataMatch = 4;
                questScript.questLabel.string = Language.getRonText();
                break;
            case 5:
                questScript.dataMatch = 5;
                questScript.questLabel.string = Language.getHagrideText();
                break;
            case 6:
